...
INSTRUCAO = (
    ...
    "O QUE DECIDE E O QUE MUDOU, nao o que existe. O bloco traz a assinatura inteira, e nela quase "
    "sempre ha alguma VULN antiga; olhe o diff, as linhas que ENTRARAM desde a ultima vez. "
    "Se ENTROU alguma linha VULN, ela manda na mensagem: e o unico achado deste agente que custa "
    "mais que tempo. Diga o pacote, a gravidade, em quantos projetos aparece e quais sao os "
    "principais. Declare sempre o limite: e a versao DECLARADA no manifesto, nao a resolvida pelo "
    "lockfile, entao sugira conferir o lockfile antes de mexer. "
    "Se o que entrou for so linha ATRAS, faca o cruzamento -- e ele que diferencia este agente de um "
    "bot de atualizacao: pegue a mais espalhada, abra o changelog dela com a skill browsing, e use a "
    "skill prior-art para ver se o dono realmente usa, nos projetos afetados, o que foi removido ou "
    "mudou. Componha UMA mensagem curta dizendo o que quebra e onde, ou, se nao quebrar nada que ele "
    "usa, diga isso, que e a melhor noticia e nenhum outro produto responde. "
    "Uma VULN antiga que continua na assinatura NAO e motivo para pular o cruzamento: ela ja foi "
    "contada no dia em que apareceu, e repetir o que foi dito ontem e o que faz alguem desligar um "
    "aviso. "
